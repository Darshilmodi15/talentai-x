  ...
  return (
    <div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-amber-800">Batch Matching Paused</p>
          <p className="text-xs text-amber-700 mt-1">
            This project is currently under review. Batch candidate matching and bias audits are temporarily disabled. You can still select and explore profiles, but executing batch matching is paused.
          </p>
        </div>
      </div>
